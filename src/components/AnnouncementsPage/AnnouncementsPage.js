...
const AnnouncementsPage = () => {
  ...
  const [announcements, setAnnouncements] = useState([
    ...
    {
      id: 4,
      title: 'Q2 Performance Results',
      content: 'Our Q2 performance results have been published. We exceeded our targets by 12% and want to thank everyone for their hard work and dedication.',
    ...
    },
    {
      ...
      content: 'We\'ve updated our health insurance benefits package. Please review the new options in the HR portal and make any changes by the end of the month.',
  ...
  useEffect(() => {
    // Check if we should open the create announcement modal based on navigation state
  ...
  const handleSubmit = (e) => {
    ...
    const id = announcements.length > 0 ? Math.max(...announcements.map(announcement => announcement.id)) + 1 : 1;
    ...
    const announcementToAdd = {
      ...
      role: 'Department Manager', // Current user's role
      avatar: 'AJ',
      date: 'Just now',
  ...
  return (
    <div className="announcements-page">
      ...
      <div className="create-announcement">
        <button className="new-announcement-btn" onClick={handleCreateAnnouncement}>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
